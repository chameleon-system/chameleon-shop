...
if (is_array($aValues) && count($aValues) > 0) {
    ...
    $aRangeStartOptions = array();
    $aRangeStartOptions[] = array('start' => 0, 'end' => 10, 'count' => 0);
    $aRangeStartOptions[] = array('start' => 10, 'end' => 20, 'count' => 0);
    $aRangeStartOptions[] = array('start' => 20, 'end' => 30, 'count' => 0);
    $aRangeStartOptions[] = array('start' => 30, 'end' => 40, 'count' => 0);
    $aRangeStartOptions[] = array('start' => 40, 'end' => 50, 'count' => 0);
    $aRangeStartOptions[] = array('start' => 50, 'end' => 75, 'count' => 0);
    $aRangeStartOptions[] = array('start' => 75, 'end' => 100, 'count' => 0);
    $aRangeStartOptions[] = array('start' => 100, 'end' => 150, 'count' => 0);
    $aRangeStartOptions[] = array('start' => 150, 'end' => 200, 'count' => 0);
    $aRangeStartOptions[] = array('start' => 200, 'end' => $dHighestValue, 'count' => 0);

    $aRangeStartOptions = array_reverse($aRangeStartOptions, true);

    $aRangKeys = array_keys($aRangeStartOptions);

    $aRangeItemsWithValueLargerZero = array();
