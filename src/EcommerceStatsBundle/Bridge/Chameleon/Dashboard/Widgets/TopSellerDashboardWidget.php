...
class TopSellerDashboardWidget extends DashboardBaseWidget
{
    ...
    protected function generateBodyHtml(): string
    {
        ...
        $this->renderer->AddSourceObject('reloadUrl', '/cms/api/dashboard/widget/chameleon_system_ecommerce_stats.bridge_chameleon_dashboard_widgets.top_seller_dashboard_widget/getStatsDataAsJson');
