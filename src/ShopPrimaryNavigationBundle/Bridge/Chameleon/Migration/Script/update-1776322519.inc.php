...
if (true === TCMSLogChange::FieldExists('pkg_shop_primary_navi', 'external_url')) {
    TCMSLogChange::SetFieldPosition('pkg_shop_primary_navi', 'external_url', 'position');

    if (false === TCMSLogChange::FieldExists('pkg_shop_primary_navi', 'open_external_link_in_new_tab')) {
