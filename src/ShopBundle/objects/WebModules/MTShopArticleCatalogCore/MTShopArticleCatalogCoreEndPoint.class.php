...
class MTShopArticleCatalogCoreEndPoint extends TShopUserCustomModelBase
{
    ...
    public function Init()
    {
        ...
        $oCategory = ServiceLocator::get('chameleon_system_shop.shop_service')->getActiveCategory();
    ...
    {
        return ServiceLocator::get('chameleon_system_shop.shop_service')->getActiveProduct();
    }
    ...
    protected function GenerateCaptcha()
    {
        ...
        $sCaptchQuestion = ServiceLocator::get('translator')->trans('chameleon_system_shop.module_article_catalog.captcha', ['%num1%' => $num1, '%num2%' => $num2]);
