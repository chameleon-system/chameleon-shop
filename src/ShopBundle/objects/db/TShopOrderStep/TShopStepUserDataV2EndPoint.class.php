...
class TShopStepUserDataV2EndPoint extends TdbShopOrderStep
{
    ...
    protected function InitShippingAddress()
    {
        ...
        if (0 !== count($shippingAddressData)) {
            ...
            if (0 !== count($billingAddressData) && TdbDataExtranetUserAddress::FORM_DATA_NAME_BILLING == $this->AddressUsedAsPrimaryAddress()) {
    ...
    protected function InitBillingAddress()
    {
        ...
        $billingAddressData = $inputFilterUtil->getFilteredPostInputArray(TdbDataExtranetUserAddress::FORM_DATA_NAME_BILLING);
        if (0 !== count($billingAddressData)) {
            $this->SetBillingAddressData($billingAddressData);
            $this->bUserDataSubmission = true;
        } else {
            $shippingAddressData = $inputFilterUtil->getFilteredPostInputArray(TdbDataExtranetUserAddress::FORM_DATA_NAME_SHIPPING);
            if (0 !== count($shippingAddressData) && TdbDataExtranetUserAddress::FORM_DATA_NAME_SHIPPING == $this->AddressUsedAsPrimaryAddress()) {
    ...
    protected function SetShipToBillingAddress($sShipToBillingAddress)
    {
        ...
        $bShipToBilling = '1' === $sShipToBillingAddress;
    ...
    protected function GetShippingAddressData($sReturnThisParameterOnly = null)
    {
        ...
        if (array_key_exists('aShipping', $this->aUserData)) {
            ...
            if (null !== $sReturnThisParameterOnly) {
