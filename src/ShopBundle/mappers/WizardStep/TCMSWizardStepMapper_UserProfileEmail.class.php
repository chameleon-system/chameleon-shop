...
class TCMSWizardStepMapper_UserProfileEmail extends AbstractTCMSWizardStepMapper
{
    /**
     * {@inheritdoc}
     */
    public function Accept(IMapperVisitorRestricted $oVisitor, $bCachingEnabled, IMapperCacheTriggerRestricted $oCacheTriggerManager): void
    {
        ...
        $oVisitor->SetMappedValue('sSuccessMessage', $this->GetMessageForField('sChangeEmailSuccess', $sCustomMSGConsumer));
    }
