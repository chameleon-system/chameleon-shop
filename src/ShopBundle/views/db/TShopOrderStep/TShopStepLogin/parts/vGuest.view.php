...
<div class="vRegisterAsNewCustomer">
    <form name="checkout" accept-charset="utf-8" method="post" action="<?php echo $oStep->GetStepURL(); ?>">
        ...
        <input type="submit" value="<?php echo TGlobal::OutHTML(ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_shop.module_checkout.login_action_order_as_guest')); ?>"/>
    </form>
</div>