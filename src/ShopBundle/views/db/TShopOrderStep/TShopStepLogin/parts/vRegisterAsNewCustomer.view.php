...
<div class="vRegisterAsNewCustomer">
    <form name="checkout" accept-charset="utf-8" method="post" action="<?=$oStep->GetStepURL(); ?>">
        ...
        <input type="submit" value="<?=TGlobal::OutHTML(\ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_shop.module_checkout.login_action_register')); ?>"/>
    </form>
</div>