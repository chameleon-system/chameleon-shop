    ...
    <div class="user">
        <script type="text/javascript">
            function SetSelectedAddress(sAddressId, sAddressName) {
                document.user.<?php echo MTShopOrderWizardCore::URL_PARAM_STEP_METHOD; ?>.value = 'ChangeSelectedAddress';
...
?>
                <div class="box">
                    <form name="user" method="post" accept-charset="UTF-8" action="<?php echo $oStep->GetStepURL(); ?>">
                        <input type="hidden" name="module_fnc[<?php echo TGlobal::OutHTML($sSpotName); ?>]" value="ExecuteStep"/>
                        <input type="hidden" name="<?php echo MTShopOrderWizardCore::URL_PARAM_STEP_METHOD; ?>" value=""/>
