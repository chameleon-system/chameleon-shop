...
<input type="hidden" name="shop_payment_method_id" value="<?php echo TGlobal::OutHTML($aCallTimeVars['iPaymentMethodId']); ?>"/>
<?php
foreach ($aInputFieldParameter as $sKey => $sValue) {
    ?><input type="hidden" name="<?php echo TGlobal::OutHTML($sKey); ?>" value="<?php echo TGlobal::OutHTML($sValue); ?>"/><?php
}
...
<div class="creditCardContainer">
    ...
    <div class="savely-info">
        ...
        <div class="isLft">
            <div
                class="font32 colorblack1"><?php echo TGlobal::OutHTML(ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_shop.payment_data_trans.security_headline')); ?></div>
            <div>(<?php echo TGlobal::OutHTML(ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_shop.payment_data_trans.security_text')); ?>
                .)
            </div>
        </div>
    ...
    <div class="inputLabel font19 colorblack1"><?php echo TGlobal::OutHTML(ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_shop.payment_data_trans.form_card_type')); ?>:</div>
    <div>
        <?php if (!array_key_exists('cc_typ', $aUserPaymentData)) {
            $aUserPaymentData['cc_typ'] = '';
        } ?>
        <?php echo TTemplateTools::SelectField('cc_typ', ['Mastercard' => 'Mastercard', 'VisaCard' => 'Visa'], 148, $aUserPaymentData['cc_typ']); ?>
    </div>

    <div class="inputLabel font19 colorblack1"><?php echo TGlobal::OutHTML(ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_shop.payment_data_trans.form_card_number')); ?></div>
    <div class="inputLabelSub">
        (<?php echo TGlobal::OutHTML(ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_shop.payment_data_trans.form_card_number_help')); ?>
        .)
    </div>
    <div>
        ...
        <?php echo TTemplateTools::TWInputField('cc_number', $aUserPaymentData['cc_number'], false, 148, $sInputControlParameter); ?>
    </div>

    <div class="inputLabel font19 colorblack1"><?php echo TGlobal::OutHTML(ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_shop.payment_data_trans.form_card_owner')); ?></div>
    <div>
        <?php if (!array_key_exists('addr_name', $aUserPaymentData)) {
            $aUserPaymentData['addr_name'] = '';
        } ?>
        <?php echo TTemplateTools::TWInputField('addr_name', $aUserPaymentData['addr_name'], false, 296, $sInputControlParameter); ?>
    </div>

    <div class="inputLabel font19 colorblack1"><?php echo TGlobal::OutHTML(ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_shop.payment_data_trans.form_card_valid_until')); ?></div>
    <div>(<?php echo TGlobal::OutHTML(ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_shop.payment_data_trans.form_card_valid_until_help')); ?>.)</div>
    <div>
        <?php
...
?>
    ...
    <div class="inputLabel font19 colorblack1"><?php echo TGlobal::OutHTML(ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_shop.payment_data_trans.form_card_checksum')); ?></div>
    <div>
        (<?php echo TGlobal::OutHTML(ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_shop.payment_data_trans.form_card_checksum_help')); ?>
        .)
    </div>
    <div class="checkNo isLft">
        ...
        <?php echo TTemplateTools::TWInputField('cc_checkcode', $aUserPaymentData['cc_checkcode'], false, false, $sInputControlParameter); ?>
    </div>
    <span class="i i-security-code isLft"></span>

    <div class="cleardiv">&nbsp;</div>
    <div
        class="colorblack1"><?php echo TGlobal::OutHTML(ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_shop.payment_data_trans.form_card_payment_time')); ?></div>
</div>
