...
$message = $translator->trans('chameleon_system_shop.product.error_no_preview_image', array(), \ChameleonSystem\CoreBundle\i18n\TranslationConstants::DOMAIN_FRONTEND);
echo $message;
