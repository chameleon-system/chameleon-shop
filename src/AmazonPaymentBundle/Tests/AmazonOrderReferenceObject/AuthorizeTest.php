...
class AuthorizeTest extends AbstractAmazonOrderReference
{
    ...
    public function test_asynchronous_success()
    {
        ...
        $response = $orderRefObject->authorize($this->order, $authRefId, 1234.56, false);
    ...
    public function test_api_error()
    {
        ...
        $exception = null;
        try {
            $orderRefObject->authorize($this->order, $authRefId, 1234.56, false);
    ...
    private function helperGetConfig(\OffAmazonPaymentsService_Model_AuthorizeResponse $expectedResponse, \OffAmazonPaymentsService_Exception $exception = null, $synchronousMode = false)
    {
        ...
        $expectedApiRequestObject->setCaptureNow(false);
        if ($synchronousMode) {
