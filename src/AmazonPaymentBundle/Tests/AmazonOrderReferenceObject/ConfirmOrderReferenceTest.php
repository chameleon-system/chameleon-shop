...
class ConfirmOrderReferenceTest extends AbstractAmazonOrderReference
{
    public function test_success()
    {
        $expectedResponse = AmazonPaymentFixturesFactory::confirmOrderReference('success.xml');

        $config = $this->helperGetConfig($expectedResponse, null);

        $orderRef = new AmazonOrderReferenceObject($config, $this->order->getAmazonOrderReferenceId());

        $orderRef->confirmOrderReference();
    }
    ...
    public function test_with_amazon_api_error()
    {
        ...
        $exception = null;
        try {
            $amazonOrderReferenceObject->confirmOrderReference();
    ...
    private function helperGetConfig(\OffAmazonPaymentsService_Model_ConfirmOrderReferenceResponse $expectedResponse, \OffAmazonPaymentsService_Exception $exception = null)
    {
        $expectedApiRequestObject = new \OffAmazonPaymentsService_Model_ConfirmOrderReferenceRequest();
