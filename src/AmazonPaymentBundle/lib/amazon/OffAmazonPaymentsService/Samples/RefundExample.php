...
class RefundExample
{
     ...
     */
    public function __construct($service, $amazonOrderReferenceId, $amazonCaptureId, $refundIdSuffix)
    {
        $this->_service = $service;
        $this->_amazonOrderReferenceId = $amazonOrderReferenceId;
        $this->_amazonCaptureId = $amazonCaptureId;
        $this->_refundReferenceId 
            = str_replace("-", "", $amazonCaptureId) . "c" . $refundIdSuffix;
     ...
     * @return void
     */
    public function refundToBuyer($refundAmount, $refundCurrency)
    {
