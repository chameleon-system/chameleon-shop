...
class AmazonAuthorizationDeclinedException extends \TPkgCmsException_LogAndMessage
{
    const REASON_CODE_INVALID_PAYMENT_METHOD = 'InvalidPaymentMethod';
    ...
    public function __construct(
        ...
        parent::__construct(
            AmazonPayment::ERROR_AUTHORIZATION_DECLINED,
            $aAdditionalData,
            $message,
            $aContextData,
            $iLogLevel,
