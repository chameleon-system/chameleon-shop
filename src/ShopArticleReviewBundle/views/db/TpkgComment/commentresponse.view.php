...
?>
                    ...
                    <div class="jscomment_inner" style="<?php if (!$oComment->IsActiveComment()) {
                        ...
                        <form name="recomment-<?php echo TGlobal::OutHTML($oComment->id); ?>" accept-charset="utf-8" method="post"
                            ...
                            <input type="submit" name="savecomment" id="editbuton-<?php echo TGlobal::OutHTML($oComment->id); ?>"
                                   ...
                                   value="<?php echo TGlobal::OutHTML(ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_shop_article_review.action.refresh')); ?>"/>
                        </form>
                    </div>
                    ...
                    <?php if ($oComment->fieldMarkAsReported) {
                        ?>
                        <div
                            class="notification <?php echo $sCmsIdent; ?>  inapplicable"><?php echo TGlobal::OutHtml(ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_shop_article_review.text.comment_inappropriate')); ?></div>
                        <?php if ($sReCommentURL) {
                            ?>
                            <div class="recomment <?php echo $sCmsIdent; ?>"><a href="<?php echo $sReCommentURL; ?>"
                                                                      onclick="RespondComment('<?php echo TGlobal::OutHTML($oComment->id); ?>','<?php echo TGlobal::OutHTML($sCmsIdent); ?>');$(this).parent().siblings('.jscomment_inner').show(400);return false;"><?php echo TGlobal::OutHTML(ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_shop_article_review.action.respond_to_comment')); ?></a>
                            </div>
                            <?php
                        } ?>
                        <?php
                        ...
                        <?php if ($sReportCommentURL) {
                            ...
                            <div class="notification <?php echo $sCmsIdent; ?>"><a
                                href="<?php echo $sReportCommentURL; ?>"><?php echo TGlobal::OutHTML(ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_shop_article_review.action.report_comment_as_inappropriate')); ?></a>
                            </div>
                            <?php
                        } ?>
                        <?php if ($sReCommentURL) {
                    ...
                    <?php
                        ...
                        ?>
                    <div
                        class="notification <?php echo $sCmsIdent; ?>  inapplicable"><?php echo TGlobal::OutHtml(ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_shop_article_review.text.deleted_comment')); ?></div>
                    <?php
                    } ?>
            ...
            <div
                class="antwortCount"><?php echo $oChildCommentList->Length().'&nbsp;'.TGlobal::OutHTML(ChameleonSystem\CoreBundle\ServiceLocator::get('translator')->trans('chameleon_system_shop_article_review.action.respond_to_comment')); ?></div>
